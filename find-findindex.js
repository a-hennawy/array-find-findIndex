...
The function should return the first object with the key of username that 
...
function removeUser(usersArray, username) {
  const users = usersArray.findIndex(function (obj) {
    return obj.username === username;
  });
  if (users === -1) return;
  return usersArray.splice(users, 1)[0];
}
